...
class windows(QWidget):
    def __init__(self, parent):
        ...
        self.count = 0
        self.input20 = ''
        self.reddit_video = ['choose type','image','video', 'subreddit']
    ...
    def text_changed(self, i):
        ...
        if len(self.website_data) != 0:
            if self.website_data == 'youtube':
                ...
                self.type.addItems(self.reddit_video)
    ...
    def refresh(self):
        ...
        for i in range(2*len(self.reddit_video), 2): 
            self.type.removeItem(i)
        self.value.setText = ''
        print(self.type.itemData(0))
